...
var resizePizzas = function(size) {
  ...
  //removed repeated code from function
  //eliminated determine DX function
...
function updatePositions() {
  ...
  var items = document.getElementsByClassName('mover'); //changed this line of code from document.querySelectorAll('.mover');
  var scrollTop = document.documentElement.scrollTop || document.body.scrollTop; //moved this variable outside of the for loop
